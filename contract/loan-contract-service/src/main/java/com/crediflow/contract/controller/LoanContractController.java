...
public class LoanContractController {
     ...
     */
    @PostMapping("/sign")
    public Result<SignContractResult> signContract(@RequestHeader("X-User-Id") Long userId,
     ...
     */
    @GetMapping("/link")
    public Result<ContractLinkResult> getContractLink(@RequestHeader("X-User-Id") Long userId,
                                                       @RequestParam Long applicationId) {
